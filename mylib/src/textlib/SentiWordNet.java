...
public class SentiWordNet {
            ...
            while ((line = csv.readLine()) != null) {
                ...
                if (!line.trim().startsWith("#")) {
                    ...
                    for (String synTermSplit : synTermsSplit) {
                        ...
                        if(synTermAndRank[0].matches(".*[0-9].*")){
                            continue;
                        }
    ...
    public boolean exportSentiWordNetDict(String dictPath) throws Exception{
        if(dictionary == null){
            return false;
        }
        ...
        long size = dictionary.size();
        JSONObject object = new JSONObject(dictionary);
    ...
    public static void main(String [] args) throws Exception {
        ...
        if(args.length<1) {
            ...
            dictSrcFile = "../lib/SentiWordNet_3.0.0_20130122.txt";
        }else {
            dictSrcFile = args[0];
        }

        SentiWordNet sentiwordnet = new SentiWordNet(dictSrcFile);

        String dictJSONFile = "../lib/SentiWordNet.json";
        sentiwordnet.exportSentiWordNetDict(dictJSONFile);
